...
import {getStatus, getUpdateStatus, getUserProfile, setUserProfile} from "../../Redux/profile-reducer";
...
export default compose<React.ComponentType>(
  connect(mapStateToProps, {setUserProfile, getUserProfile, getStatus, getUpdateStatus}),
  withAuthRedirect,
  withRouter
)(ProfileContainer)
